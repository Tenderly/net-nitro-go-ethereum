...
import (
	...
	"github.com/tenderly/net-nitro-go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-nitro-go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-nitro-go-ethereum/internal/version.gitDate="+env.Date)
	}
